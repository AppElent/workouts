...
export const en = {
	...
	nutrition: {
		...
		day: {
			...
			energyLogged: "{amount} kcal logged",
			energyRemaining: "{amount} kcal remaining",
			energyToMinimum: "{amount} kcal to minimum",
			energyToRange: "{amount} kcal to range",
			energyTargetReached: "Target reached",
			energyMinimumReached: "Minimum reached",
			energyWithinRange: "Within target range",
			energyAboveTarget: "{amount} kcal above target",
			energyAboveRange: "{amount} kcal above range",
			knownEnergy: "Known energy: {amount} kcal · incomplete",
			unavailableEnergy: "Energy unavailable",
			approximateEnergy: "Recorded energy: {amount} kcal · approximate",
			energyReference: "{logged} logged / {target} target",
			energyRangeReference: "{logged} logged / {min}–{max} target",
			energyNoGoal: "Set an energy goal to compare intake.",
			reviewGoals: "Review goals",
			additionalGoals: "Additional goals ({count})",
			showAdditionalGoals: "Show additional goals",
		...
		foodBrowser: {
			...
			closeServing: "Done",
			sheetHandle: "Serving options sheet",
			serving: "Serving",
			quantity: "Quantity",
			trace: "Trace",
			...
			energyUnavailablePer100: "Energy unavailable / 100 {unit}",
			energyTracePer100: "Trace / 100 {unit}",
			addFood: "Add food",
			addAndContinue: "Add & continue",
			addAndClose: "Add & close",
			addedToMeal: "Added {food} to {meal}",
			addedThisVisit: "Added this visit",
			removeAddedFood: "Remove {food} from {meal}",
			mealPicker: "Meal",
			done: "Done",
			quantityHalf: "½",
			quantityOne: "1",
		...
		foodImport: {
			...
			unavailable:
				"Open Food Facts is temporarily unavailable. Try searching again shortly. You can still use local foods or add food manually.",
		...
		personalFood: {
			...
			storageTitle: "Local storage and optional backup",
			storageBody:
				"Personal Foods are stored locally. Enable account backup in More nutrition tools to back them up and restore them on another device. Without backup, uninstalling Workouts may remove them.",
			nameEn: "English name",
			nameNl: "Dutch name",
		...
		combos: {
			...
			storageTitle: "Local storage and optional backup",
			storageBody:
				"Combos are available offline. Enable account backup in More nutrition tools to back them up and restore them on another device. Without backup, uninstalling may remove them. Diary logs sync separately when connected.",
			name: "Combo name",
			save: "Save Combo",
			saving: "Saving Combo…",
			saved: "Combo saved.",
