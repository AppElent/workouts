...
// Source: https://github.com/wrkout/exercises.json/tree/5994bea047eee4d39a2c0872be3dd8fdd258ba31
// Public domain (Unlicense); see wrkout-LICENSE.txt and README.md.
import type { DefaultExercise } from "./exercises";

export const WRKOUT_EXERCISES: DefaultExercise[] = [
	{
		_id: "shipped:exercise:3-4-sit-up",
		name: "3/4 Sit-Up",
		muscleGroups: ["core"],
		category: "compound",
	...
	{
		_id: "shipped:exercise:ab-crunch-machine",
	...
	{
		_id: "shipped:exercise:advanced-kettlebell-windmill",
	...
	{
		_id: "shipped:exercise:alternate-hammer-curl",
	...
	{
		_id: "shipped:exercise:alternate-heel-touchers",
	...
	{
		_id: "shipped:exercise:alternate-incline-dumbbell-curl",
	...
	{
		_id: "shipped:exercise:alternating-cable-shoulder-press",
	...
	{
		_id: "shipped:exercise:alternating-deltoid-raise",
	...
	{
		_id: "shipped:exercise:alternating-floor-press",
		name: "Alternating Floor Press",
		muscleGroups: ["chest", "core", "shoulders", "triceps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:alternating-hang-clean",
	...
	{
		_id: "shipped:exercise:alternating-kettlebell-press",
	...
	{
		_id: "shipped:exercise:alternating-kettlebell-row",
	...
	{
		_id: "shipped:exercise:alternating-renegade-row",
		name: "Alternating Renegade Row",
		muscleGroups: ["back", "core", "biceps", "chest", "triceps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:anti-gravity-press",
		name: "Anti-Gravity Press",
		muscleGroups: ["shoulders", "back", "traps", "triceps"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:around-the-worlds",
	...
	{
		_id: "shipped:exercise:atlas-stone-trainer",
	...
	{
		_id: "shipped:exercise:atlas-stones",
		name: "Atlas Stones",
		muscleGroups: [
			"lower back",
			"core",
	...
	{
		_id: "shipped:exercise:axle-deadlift",
		name: "Axle Deadlift",
		muscleGroups: [
			"lower back",
			"forearms",
	...
	{
		_id: "shipped:exercise:back-flyes-with-bands",
	...
	{
		_id: "shipped:exercise:backward-drag",
		name: "Backward Drag",
		muscleGroups: [
			"quadriceps",
			"calves",
	...
	{
		_id: "shipped:exercise:balance-board",
		name: "Balance Board",
	...
	{
		_id: "shipped:exercise:ball-leg-curl",
		name: "Ball Leg Curl",
	...
	{
		_id: "shipped:exercise:band-assisted-pull-up",
	...
	{
		_id: "shipped:exercise:band-good-morning",
	...
	{
		_id: "shipped:exercise:band-good-morning-pull-through",
	...
	{
		_id: "shipped:exercise:band-hip-adductions",
	...
	{
		_id: "shipped:exercise:band-pull-apart",
	...
	{
		_id: "shipped:exercise:band-skull-crusher",
	...
	{
		_id: "shipped:exercise:barbell-ab-rollout",
	...
	{
		_id: "shipped:exercise:barbell-ab-rollout-on-knees",
	...
	{
		_id: "shipped:exercise:barbell-curl",
		name: "Barbell Curl",
		muscleGroups: ["biceps", "forearms"],
		category: "isolation",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:barbell-curls-lying-against-an-incline",
	...
	{
		_id: "shipped:exercise:barbell-full-squat",
	...
	{
		_id: "shipped:exercise:barbell-glute-bridge",
	...
	{
		_id: "shipped:exercise:barbell-guillotine-bench-press",
	...
	{
		_id: "shipped:exercise:barbell-hack-squat",
		name: "Barbell Hack Squat",
		muscleGroups: ["quadriceps", "calves", "forearms", "hamstrings"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:barbell-incline-shoulder-raise",
	...
	{
		_id: "shipped:exercise:barbell-lunge",
		name: "Barbell Lunge",
		muscleGroups: ["quadriceps", "calves", "glutes", "hamstrings"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:barbell-rear-delt-row",
	...
	{
		_id: "shipped:exercise:barbell-rollout-from-bench",
		name: "Barbell Rollout from Bench",
		muscleGroups: ["core", "glutes", "hamstrings", "back", "shoulders"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:barbell-seated-calf-raise",
	...
	{
		_id: "shipped:exercise:barbell-shoulder-press",
	...
	{
		_id: "shipped:exercise:barbell-shrug-behind-the-back",
		name: "Barbell Shrug Behind The Back",
		muscleGroups: ["traps", "forearms", "back"],
		category: "isolation",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:barbell-side-bend",
	...
	{
		_id: "shipped:exercise:barbell-side-split-squat",
		name: "Barbell Side Split Squat",
		muscleGroups: ["quadriceps", "calves", "hamstrings", "lower back"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:barbell-squat-to-a-bench",
	...
	{
		_id: "shipped:exercise:barbell-step-ups",
	...
	{
		_id: "shipped:exercise:barbell-walking-lunge",
	...
	{
		_id: "shipped:exercise:battling-ropes",
		name: "Battling Ropes",
	...
	{
		_id: "shipped:exercise:bear-crawl-sled-drags",
	...
	{
		_id: "shipped:exercise:bench-dips",
		name: "Bench Dips",
	...
	{
		_id: "shipped:exercise:bench-press-powerlifting",
	...
	{
		_id: "shipped:exercise:bench-press-with-bands",
	...
	{
		_id: "shipped:exercise:bench-press-with-chains",
	...
	{
		_id: "shipped:exercise:bent-arm-barbell-pullover",
	...
	{
		_id: "shipped:exercise:bent-arm-dumbbell-pullover",
	...
	{
		_id: "shipped:exercise:bent-knee-hip-raise",
	...
	{
		_id: "shipped:exercise:bent-over-dumbbell-rear-delt-raise-with-head-on-bench",
	...
	{
		_id: "shipped:exercise:bent-over-low-pulley-side-lateral",
		name: "Bent Over Low-Pulley Side Lateral",
		muscleGroups: ["shoulders", "lower back", "back", "traps"],
		category: "isolation",
		equipment: "cable",
		instructions: [
	...
	{
		_id: "shipped:exercise:bent-over-one-arm-long-bar-row",
		name: "Bent Over One-Arm Long Bar Row",
		muscleGroups: ["back", "biceps", "lower back", "traps"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:bent-over-two-arm-long-bar-row",
	...
	{
		_id: "shipped:exercise:bent-over-two-dumbbell-row",
	...
	{
		_id: "shipped:exercise:bent-over-two-dumbbell-row-with-palms-in",
	...
	{
		_id: "shipped:exercise:bent-press",
		name: "Bent Press",
		muscleGroups: [
			"core",
			"glutes",
	...
	{
		_id: "shipped:exercise:board-press",
		name: "Board Press",
		muscleGroups: ["triceps", "chest", "forearms", "back", "shoulders"],
		category: "compound",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:body-up",
		name: "Body-Up",
		muscleGroups: ["triceps", "core", "forearms"],
		category: "isolation",
		equipment: "bodyweight",
		instructions: [
	...
	{
		_id: "shipped:exercise:body-tricep-press",
	...
	{
		_id: "shipped:exercise:bodyweight-flyes",
	...
	{
		_id: "shipped:exercise:bodyweight-mid-row",
	...
	{
		_id: "shipped:exercise:bodyweight-squat",
	...
	{
		_id: "shipped:exercise:bodyweight-walking-lunge",
	...
	{
		_id: "shipped:exercise:bosu-ball-cable-crunch-with-side-bends",
	...
	{
		_id: "shipped:exercise:bottoms-up-clean-from-the-hang-position",
	...
	{
		_id: "shipped:exercise:bottoms-up",
		name: "Bottoms Up",
		muscleGroups: ["core"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:box-squat",
		name: "Box Squat",
		muscleGroups: [
			"quadriceps",
			"adductors",
	...
	{
		_id: "shipped:exercise:box-squat-with-bands",
	...
	{
		_id: "shipped:exercise:box-squat-with-chains",
	...
	{
		_id: "shipped:exercise:bradford-rocky-presses",
	...
	{
		_id: "shipped:exercise:butt-lift-bridge",
	...
	{
		_id: "shipped:exercise:butterfly",
		name: "Butterfly",
		muscleGroups: ["chest"],
		category: "isolation",
		equipment: "machine",
	...
	{
		_id: "shipped:exercise:cable-chest-press",
	...
	{
		_id: "shipped:exercise:cable-deadlifts",
	...
	{
		_id: "shipped:exercise:cable-hammer-curls-rope-attachment",
	...
	{
		_id: "shipped:exercise:cable-hip-adduction",
	...
	{
		_id: "shipped:exercise:cable-incline-pushdown",
	...
	{
		_id: "shipped:exercise:cable-incline-triceps-extension",
	...
	{
		_id: "shipped:exercise:cable-internal-rotation",
	...
	{
		_id: "shipped:exercise:cable-iron-cross",
	...
	{
		_id: "shipped:exercise:cable-judo-flip",
	...
	{
		_id: "shipped:exercise:cable-lying-triceps-extension",
	...
	{
		_id: "shipped:exercise:cable-one-arm-tricep-extension",
	...
	{
		_id: "shipped:exercise:cable-preacher-curl",
	...
	{
		_id: "shipped:exercise:cable-rear-delt-fly",
	...
	{
		_id: "shipped:exercise:cable-reverse-crunch",
	...
	{
		_id: "shipped:exercise:cable-rope-overhead-triceps-extension",
	...
	{
		_id: "shipped:exercise:cable-rope-rear-delt-rows",
	...
	{
		_id: "shipped:exercise:cable-russian-twists",
	...
	{
		_id: "shipped:exercise:cable-seated-crunch",
	...
	{
		_id: "shipped:exercise:cable-seated-lateral-raise",
	...
	{
		_id: "shipped:exercise:cable-shoulder-press",
	...
	{
		_id: "shipped:exercise:cable-shrugs",
		name: "Cable Shrugs",
		muscleGroups: ["traps"],
		category: "isolation",
		equipment: "cable",
	...
	{
		_id: "shipped:exercise:cable-wrist-curl",
	...
	{
		_id: "shipped:exercise:calf-machine-shoulder-shrug",
	...
	{
		_id: "shipped:exercise:calf-press",
		name: "Calf Press",
		muscleGroups: ["calves"],
		category: "isolation",
		equipment: "machine",
	...
	{
		_id: "shipped:exercise:calf-press-on-the-leg-press-machine",
	...
	{
		_id: "shipped:exercise:calf-raise-on-a-dumbbell",
	...
	{
		_id: "shipped:exercise:calf-raises-with-bands",
	...
	{
		_id: "shipped:exercise:car-deadlift",
		name: "Car Deadlift",
		muscleGroups: [
			"quadriceps",
			"forearms",
	...
	{
		_id: "shipped:exercise:car-drivers",
		name: "Car Drivers",
	...
	{
		_id: "shipped:exercise:chain-handle-extension",
	...
	{
		_id: "shipped:exercise:chain-press",
		name: "Chain Press",
		muscleGroups: ["chest", "shoulders", "triceps"],
		category: "compound",
		equipment: "other",
	...
	{
		_id: "shipped:exercise:chair-squat",
		name: "Chair Squat",
		muscleGroups: ["quadriceps", "calves", "glutes", "hamstrings"],
		category: "compound",
		equipment: "machine",
	...
	{
		_id: "shipped:exercise:circus-bell",
		name: "Circus Bell",
		muscleGroups: [
			"shoulders",
			"forearms",
	...
	{
		_id: "shipped:exercise:clean-deadlift",
		name: "Clean Deadlift",
		muscleGroups: [
			"hamstrings",
			"forearms",
	...
	{
		_id: "shipped:exercise:clean-pull",
		name: "Clean Pull",
		muscleGroups: [
			"quadriceps",
			"forearms",
	...
	{
		_id: "shipped:exercise:clean-shrug",
		name: "Clean Shrug",
		muscleGroups: ["traps", "forearms", "shoulders"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:clean-and-jerk",
		name: "Clean and Jerk",
		muscleGroups: [
			"shoulders",
			"core",
	...
	{
		_id: "shipped:exercise:clean-and-press",
	...
	{
		_id: "shipped:exercise:clean-from-blocks",
	...
	{
		_id: "shipped:exercise:clock-push-up",
		name: "Clock Push-Up",
		muscleGroups: ["chest", "shoulders", "triceps"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:close-grip-dumbbell-press",
	...
	{
		_id: "shipped:exercise:close-grip-ez-bar-curl-with-band",
	...
	{
		_id: "shipped:exercise:close-grip-ez-bar-press",
	...
	{
		_id: "shipped:exercise:close-grip-ez-bar-curl",
	...
	{
		_id: "shipped:exercise:close-grip-front-lat-pulldown",
	...
	{
		_id: "shipped:exercise:close-grip-push-up-off-of-a-dumbbell",
		name: "Close-Grip Push-Up off of a Dumbbell",
		muscleGroups: ["triceps", "core", "chest", "shoulders"],
		category: "compound",
		equipment: "bodyweight",
		instructions: [
	...
	{
		_id: "shipped:exercise:close-grip-standing-barbell-curl",
	...
	{
		_id: "shipped:exercise:conan-s-wheel",
		name: "Conan's Wheel",
		muscleGroups: [
			"quadriceps",
			"core",
	...
	{
		_id: "shipped:exercise:concentration-curls",
	...
	{
		_id: "shipped:exercise:cross-body-crunch",
	...
	{
		_id: "shipped:exercise:cross-body-hammer-curl",
	...
	{
		_id: "shipped:exercise:cross-over-with-bands",
	...
	{
		_id: "shipped:exercise:crunch-hands-overhead",
	...
	{
		_id: "shipped:exercise:crunch-legs-on-exercise-ball",
	...
	{
		_id: "shipped:exercise:cuban-press",
		name: "Cuban Press",
	...
	{
		_id: "shipped:exercise:deadlift-with-bands",
	...
	{
		_id: "shipped:exercise:deadlift-with-chains",
	...
	{
		_id: "shipped:exercise:decline-close-grip-bench-to-skull-crusher",
	...
	{
		_id: "shipped:exercise:decline-crunch",
		name: "Decline Crunch",
		muscleGroups: ["core"],
		category: "isolation",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:decline-dumbbell-bench-press",
	...
	{
		_id: "shipped:exercise:decline-dumbbell-flyes",
	...
	{
		_id: "shipped:exercise:decline-dumbbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:decline-ez-bar-triceps-extension",
	...
	{
		_id: "shipped:exercise:decline-oblique-crunch",
	...
	{
		_id: "shipped:exercise:decline-push-up",
	...
	{
		_id: "shipped:exercise:decline-reverse-crunch",
	...
	{
		_id: "shipped:exercise:decline-smith-press",
	...
	{
		_id: "shipped:exercise:deficit-deadlift",
	...
	{
		_id: "shipped:exercise:dip-machine",
		name: "Dip Machine",
		muscleGroups: ["triceps", "chest", "shoulders"],
		category: "compound",
		equipment: "machine",
	...
	{
		_id: "shipped:exercise:donkey-calf-raises",
	...
	{
		_id: "shipped:exercise:double-kettlebell-alternating-hang-clean",
	...
	{
		_id: "shipped:exercise:double-kettlebell-jerk",
		name: "Double Kettlebell Jerk",
		muscleGroups: ["shoulders", "calves", "quadriceps", "triceps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:double-kettlebell-push-press",
	...
	{
		_id: "shipped:exercise:double-kettlebell-snatch",
		name: "Double Kettlebell Snatch",
		muscleGroups: ["shoulders", "glutes", "hamstrings", "quadriceps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:double-kettlebell-windmill",
		name: "Double Kettlebell Windmill",
		muscleGroups: ["core", "glutes", "hamstrings", "shoulders", "triceps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:downward-facing-balance",
	...
	{
		_id: "shipped:exercise:drag-curl",
		name: "Drag Curl",
		muscleGroups: ["biceps", "forearms"],
		category: "compound",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:dumbbell-alternate-bicep-curl",
	...
	{
		_id: "shipped:exercise:dumbbell-bench-press-with-neutral-grip",
	...
	{
		_id: "shipped:exercise:dumbbell-clean",
		name: "Dumbbell Clean",
		muscleGroups: [
			"hamstrings",
			"calves",
	...
	{
		_id: "shipped:exercise:dumbbell-floor-press",
	...
	{
		_id: "shipped:exercise:dumbbell-incline-row",
	...
	{
		_id: "shipped:exercise:dumbbell-incline-shoulder-raise",
	...
	{
		_id: "shipped:exercise:dumbbell-lunges",
	...
	{
		_id: "shipped:exercise:dumbbell-lying-one-arm-rear-lateral-raise",
	...
	{
		_id: "shipped:exercise:dumbbell-lying-pronation",
	...
	{
		_id: "shipped:exercise:dumbbell-lying-rear-lateral-raise",
	...
	{
		_id: "shipped:exercise:dumbbell-lying-supination",
	...
	{
		_id: "shipped:exercise:dumbbell-one-arm-shoulder-press",
	...
	{
		_id: "shipped:exercise:dumbbell-one-arm-triceps-extension",
	...
	{
		_id: "shipped:exercise:dumbbell-one-arm-upright-row",
		name: "Dumbbell One-Arm Upright Row",
		muscleGroups: ["shoulders", "biceps", "traps"],
		category: "compound",
		equipment: "dumbbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:dumbbell-prone-incline-curl",
	...
	{
		_id: "shipped:exercise:dumbbell-raise",
		name: "Dumbbell Raise",
	...
	{
		_id: "shipped:exercise:dumbbell-rear-lunge",
	...
	{
		_id: "shipped:exercise:dumbbell-scaption",
	...
	{
		_id: "shipped:exercise:dumbbell-seated-one-leg-calf-raise",
	...
	{
		_id: "shipped:exercise:dumbbell-shrug",
		name: "Dumbbell Shrug",
		muscleGroups: ["traps"],
		category: "isolation",
		equipment: "dumbbell",
	...
	{
		_id: "shipped:exercise:dumbbell-side-bend",
	...
	{
		_id: "shipped:exercise:dumbbell-squat",
		name: "Dumbbell Squat",
		muscleGroups: [
			"quadriceps",
			"calves",
	...
	{
		_id: "shipped:exercise:dumbbell-squat-to-a-bench",
	...
	{
		_id: "shipped:exercise:dumbbell-step-ups",
	...
	{
		_id: "shipped:exercise:dumbbell-tricep-extension-pronated-grip",
	...
	{
		_id: "shipped:exercise:elbow-to-knee",
		name: "Elbow to Knee",
		muscleGroups: ["core"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:elevated-back-lunge",
	...
	{
		_id: "shipped:exercise:elevated-cable-rows",
	...
	{
		_id: "shipped:exercise:exercise-ball-crunch",
	...
	{
		_id: "shipped:exercise:exercise-ball-pull-in",
	...
	{
		_id: "shipped:exercise:extended-range-one-arm-kettlebell-floor-press",
	...
	{
		_id: "shipped:exercise:external-rotation",
	...
	{
		_id: "shipped:exercise:external-rotation-with-band",
	...
	{
		_id: "shipped:exercise:external-rotation-with-cable",
	...
	{
		_id: "shipped:exercise:farmer-s-walk",
		name: "Farmer's Walk",
		muscleGroups: [
			"forearms",
			"core",
	...
	{
		_id: "shipped:exercise:finger-curls",
		name: "Finger Curls",
		muscleGroups: ["forearms"],
		category: "isolation",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:flat-bench-cable-flyes",
	...
	{
		_id: "shipped:exercise:flat-bench-leg-pull-in",
	...
	{
		_id: "shipped:exercise:flat-bench-lying-leg-raise",
	...
	{
		_id: "shipped:exercise:flexor-incline-dumbbell-curls",
	...
	{
		_id: "shipped:exercise:floor-glute-ham-raise",
	...
	{
		_id: "shipped:exercise:floor-press",
		name: "Floor Press",
		muscleGroups: ["triceps", "chest", "shoulders"],
		category: "compound",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:floor-press-with-chains",
	...
	{
		_id: "shipped:exercise:flutter-kicks",
		name: "Flutter Kicks",
		muscleGroups: ["glutes", "hamstrings"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:forward-drag-with-press",
	...
	{
		_id: "shipped:exercise:frankenstein-squat",
		name: "Frankenstein Squat",
		muscleGroups: ["quadriceps", "core", "calves", "glutes", "hamstrings"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:freehand-jump-squat",
	...
	{
		_id: "shipped:exercise:frog-sit-ups",
		name: "Frog Sit-Ups",
		muscleGroups: ["core"],
		category: "isolation",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:front-barbell-squat-to-a-bench",
	...
	{
		_id: "shipped:exercise:front-cable-raise",
	...
	{
		_id: "shipped:exercise:front-dumbbell-raise",
	...
	{
		_id: "shipped:exercise:front-incline-dumbbell-raise",
	...
	{
		_id: "shipped:exercise:front-plate-raise",
	...
	{
		_id: "shipped:exercise:front-raise-and-pullover",
	...
	{
		_id: "shipped:exercise:front-squat-clean-grip",
		name: "Front Squat (Clean Grip)",
		muscleGroups: ["quadriceps", "core", "glutes", "hamstrings"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:front-squats-with-two-kettlebells",
	...
	{
		_id: "shipped:exercise:front-two-dumbbell-raise",
	...
	{
		_id: "shipped:exercise:full-range-of-motion-lat-pulldown",
	...
	{
		_id: "shipped:exercise:gironda-sternum-chins",
	...
	{
		_id: "shipped:exercise:glute-ham-raise",
	...
	{
		_id: "shipped:exercise:glute-kickback",
		name: "Glute Kickback",
		muscleGroups: ["glutes", "hamstrings"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:good-morning-off-pins",
		name: "Good Morning off Pins",
		muscleGroups: ["hamstrings", "core", "glutes", "lower back"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:gorilla-chin-crunch",
		name: "Gorilla Chin/Crunch",
		muscleGroups: ["core", "biceps", "back"],
		category: "compound",
		equipment: "bodyweight",
		instructions: [
	...
	{
		_id: "shipped:exercise:hack-squat",
		name: "Hack Squat",
		muscleGroups: ["quadriceps", "calves", "glutes", "hamstrings"],
		category: "compound",
		equipment: "machine",
	...
	{
		_id: "shipped:exercise:hammer-grip-incline-db-bench-press",
	...
	{
		_id: "shipped:exercise:handstand-push-ups",
	...
	{
		_id: "shipped:exercise:hang-clean",
		name: "Hang Clean",
		muscleGroups: [
			"quadriceps",
			"calves",
	...
	{
		_id: "shipped:exercise:hang-clean-below-the-knees",
	...
	{
		_id: "shipped:exercise:hang-snatch",
		name: "Hang Snatch",
		muscleGroups: [
			"hamstrings",
			"core",
	...
	{
		_id: "shipped:exercise:hang-snatch-below-knees",
	...
	{
		_id: "shipped:exercise:hanging-bar-good-morning",
	...
	{
		_id: "shipped:exercise:hanging-pike",
		name: "Hanging Pike",
		muscleGroups: ["core"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:heaving-snatch-balance",
	...
	{
		_id: "shipped:exercise:high-cable-curls",
	...
	{
		_id: "shipped:exercise:hip-extension-with-bands",
	...
	{
		_id: "shipped:exercise:hip-flexion-with-band",
	...
	{
		_id: "shipped:exercise:hip-lift-with-band",
	...
	{
		_id: "shipped:exercise:hyperextensions-with-no-hyperextension-bench",
	...
	{
		_id: "shipped:exercise:incline-barbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:incline-bench-pull",
	...
	{
		_id: "shipped:exercise:incline-cable-chest-press",
	...
	{
		_id: "shipped:exercise:incline-cable-flye",
	...
	{
		_id: "shipped:exercise:incline-dumbbell-bench-with-palms-facing-in",
	...
	{
		_id: "shipped:exercise:incline-dumbbell-curl",
	...
	{
		_id: "shipped:exercise:incline-dumbbell-flyes",
	...
	{
		_id: "shipped:exercise:incline-dumbbell-flyes-with-a-twist",
	...
	{
		_id: "shipped:exercise:incline-dumbbell-press",
	...
	{
		_id: "shipped:exercise:incline-hammer-curls",
	...
	{
		_id: "shipped:exercise:incline-inner-biceps-curl",
	...
	{
		_id: "shipped:exercise:incline-push-up",
	...
	{
		_id: "shipped:exercise:incline-push-up-close-grip",
	...
	{
		_id: "shipped:exercise:incline-push-up-medium",
	...
	{
		_id: "shipped:exercise:incline-push-up-reverse-grip",
	...
	{
		_id: "shipped:exercise:incline-push-up-wide",
	...
	{
		_id: "shipped:exercise:internal-rotation-with-band",
	...
	{
		_id: "shipped:exercise:inverted-row",
		name: "Inverted Row",
		muscleGroups: ["back"],
		category: "compound",
		equipment: "other",
	...
	{
		_id: "shipped:exercise:inverted-row-with-straps",
	...
	{
		_id: "shipped:exercise:isometric-neck-exercise-front-and-back",
	...
	{
		_id: "shipped:exercise:isometric-neck-exercise-sides",
	...
	{
		_id: "shipped:exercise:isometric-wipers",
	...
	{
		_id: "shipped:exercise:jackknife-sit-up",
	...
	{
		_id: "shipped:exercise:janda-sit-up",
		name: "Janda Sit-Up",
		muscleGroups: ["core"],
		category: "isolation",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:jefferson-squats",
	...
	{
		_id: "shipped:exercise:jerk-balance",
		name: "Jerk Balance",
		muscleGroups: [
			"shoulders",
			"glutes",
	...
	{
		_id: "shipped:exercise:jerk-dip-squat",
		name: "Jerk Dip Squat",
		muscleGroups: ["quadriceps", "core", "calves"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:kettlebell-arnold-press",
	...
	{
		_id: "shipped:exercise:kettlebell-dead-clean",
	...
	{
		_id: "shipped:exercise:kettlebell-figure-8",
	...
	{
		_id: "shipped:exercise:kettlebell-hang-clean",
	...
	{
		_id: "shipped:exercise:kettlebell-one-legged-deadlift",
	...
	{
		_id: "shipped:exercise:kettlebell-pass-between-the-legs",
	...
	{
		_id: "shipped:exercise:kettlebell-pirate-ships",
	...
	{
		_id: "shipped:exercise:kettlebell-pistol-squat",
		name: "Kettlebell Pistol Squat",
		muscleGroups: ["quadriceps", "calves", "glutes", "hamstrings", "shoulders"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:kettlebell-seated-press",
	...
	{
		_id: "shipped:exercise:kettlebell-seesaw-press",
	...
	{
		_id: "shipped:exercise:kettlebell-sumo-high-pull",
	...
	{
		_id: "shipped:exercise:kettlebell-thruster",
		name: "Kettlebell Thruster",
		muscleGroups: ["shoulders", "quadriceps", "triceps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:kettlebell-turkish-get-up-lunge-style",
		name: "Kettlebell Turkish Get-Up (Lunge style)",
		muscleGroups: ["shoulders", "core", "hamstrings", "quadriceps", "triceps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:kettlebell-turkish-get-up-squat-style",
	...
	{
		_id: "shipped:exercise:kettlebell-windmill",
	...
	{
		_id: "shipped:exercise:kipping-muscle-up",
	...
	{
		_id: "shipped:exercise:knee-hip-raise-on-parallel-bars",
	...
	{
		_id: "shipped:exercise:kneeling-cable-crunch-with-alternating-oblique-twists",
	...
	{
		_id: "shipped:exercise:kneeling-cable-triceps-extension",
	...
	{
		_id: "shipped:exercise:kneeling-high-pulley-row",
	...
	{
		_id: "shipped:exercise:kneeling-jump-squat",
		name: "Kneeling Jump Squat",
		muscleGroups: ["glutes", "calves", "hamstrings", "quadriceps"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:kneeling-single-arm-high-pulley-row",
	...
	{
		_id: "shipped:exercise:kneeling-squat",
		name: "Kneeling Squat",
		muscleGroups: ["glutes", "core", "hamstrings", "lower back"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:landmine-180-s",
		name: "Landmine 180's",
	...
	{
		_id: "shipped:exercise:landmine-linear-jammer",
	...
	{
		_id: "shipped:exercise:lateral-raise-with-bands",
	...
	{
		_id: "shipped:exercise:leg-over-floor-press",
	...
	{
		_id: "shipped:exercise:leg-pull-in",
		name: "Leg Pull-In",
		muscleGroups: ["core"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:leverage-chest-press",
	...
	{
		_id: "shipped:exercise:leverage-deadlift",
	...
	{
		_id: "shipped:exercise:leverage-decline-chest-press",
	...
	{
		_id: "shipped:exercise:leverage-high-row",
	...
	{
		_id: "shipped:exercise:leverage-incline-chest-press",
	...
	{
		_id: "shipped:exercise:leverage-iso-row",
	...
	{
		_id: "shipped:exercise:leverage-shoulder-press",
	...
	{
		_id: "shipped:exercise:leverage-shrug",
		name: "Leverage Shrug",
	...
	{
		_id: "shipped:exercise:london-bridges",
		name: "London Bridges",
	...
	{
		_id: "shipped:exercise:low-cable-crossover",
	...
	{
		_id: "shipped:exercise:low-cable-triceps-extension",
	...
	{
		_id: "shipped:exercise:low-pulley-row-to-neck",
		name: "Low Pulley Row To Neck",
		muscleGroups: ["shoulders", "biceps", "back", "traps"],
		category: "compound",
		equipment: "cable",
		instructions: [
	...
	{
		_id: "shipped:exercise:lunge-pass-through",
		name: "Lunge Pass Through",
		muscleGroups: ["hamstrings", "calves", "glutes", "quadriceps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:lunge-sprint",
		name: "Lunge Sprint",
		muscleGroups: ["quadriceps", "calves", "glutes", "hamstrings"],
		category: "compound",
		equipment: "machine",
	...
	{
		_id: "shipped:exercise:lying-cable-curl",
	...
	{
		_id: "shipped:exercise:lying-cambered-barbell-row",
	...
	{
		_id: "shipped:exercise:lying-close-grip-bar-curl-on-high-pulley",
	...
	{
		_id: "shipped:exercise:lying-close-grip-barbell-triceps-extension-behind-the-head",
	...
	{
		_id: "shipped:exercise:lying-close-grip-barbell-triceps-press-to-chin",
	...
	{
		_id: "shipped:exercise:lying-dumbbell-tricep-extension",
	...
	{
		_id: "shipped:exercise:lying-face-down-plate-neck-resistance",
	...
	{
		_id: "shipped:exercise:lying-face-up-plate-neck-resistance",
	...
	{
		_id: "shipped:exercise:lying-high-bench-barbell-curl",
	...
	{
		_id: "shipped:exercise:lying-machine-squat",
	...
	{
		_id: "shipped:exercise:lying-one-arm-lateral-raise",
	...
	{
		_id: "shipped:exercise:lying-rear-delt-raise",
	...
	{
		_id: "shipped:exercise:lying-supine-dumbbell-curl",
	...
	{
		_id: "shipped:exercise:lying-t-bar-row",
	...
	{
		_id: "shipped:exercise:lying-triceps-press",
	...
	{
		_id: "shipped:exercise:machine-bench-press",
	...
	{
		_id: "shipped:exercise:machine-bicep-curl",
	...
	{
		_id: "shipped:exercise:machine-preacher-curls",
	...
	{
		_id: "shipped:exercise:machine-shoulder-military-press",
	...
	{
		_id: "shipped:exercise:machine-triceps-extension",
	...
	{
		_id: "shipped:exercise:middle-back-shrug",
	...
	{
		_id: "shipped:exercise:mixed-grip-chin",
	...
	{
		_id: "shipped:exercise:monster-walk",
		name: "Monster Walk",
	...
	{
		_id: "shipped:exercise:muscle-snatch",
		name: "Muscle Snatch",
		muscleGroups: [
			"hamstrings",
			"glutes",
	...
	{
		_id: "shipped:exercise:muscle-up",
		name: "Muscle Up",
		muscleGroups: [
			"back",
			"core",
	...
	{
		_id: "shipped:exercise:narrow-stance-hack-squats",
	...
	{
		_id: "shipped:exercise:narrow-stance-leg-press",
	...
	{
		_id: "shipped:exercise:narrow-stance-squats",
	...
	{
		_id: "shipped:exercise:natural-glute-ham-raise",
		name: "Natural Glute Ham Raise",
		muscleGroups: ["hamstrings", "calves", "glutes", "lower back"],
		category: "compound",
		equipment: "bodyweight",
		instructions: [
	...
	{
		_id: "shipped:exercise:neck-press",
		name: "Neck Press",
		muscleGroups: ["chest", "shoulders", "triceps"],
		category: "compound",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:oblique-crunches",
	...
	{
		_id: "shipped:exercise:oblique-crunches-on-the-floor",
	...
	{
		_id: "shipped:exercise:olympic-squat",
		name: "Olympic Squat",
		muscleGroups: ["quadriceps", "calves", "glutes", "hamstrings"],
		category: "compound",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:one-arm-flat-bench-dumbbell-flye",
	...
	{
		_id: "shipped:exercise:one-arm-high-pulley-cable-side-bends",
	...
	{
		_id: "shipped:exercise:one-arm-incline-lateral-raise",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-clean",
		name: "One-Arm Kettlebell Clean",
		muscleGroups: ["hamstrings", "glutes", "lower back", "shoulders", "traps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-clean-and-jerk",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-floor-press",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-jerk",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-military-press-to-the-side",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-para-press",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-push-press",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-row",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-snatch",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-split-jerk",
	...
	{
		_id: "shipped:exercise:one-arm-kettlebell-split-snatch",
		name: "One-Arm Kettlebell Split Snatch",
		muscleGroups: ["shoulders", "hamstrings", "quadriceps"],
		category: "compound",
		equipment: "kettlebell",
		instructions: [
	...
	{
		_id: "shipped:exercise:one-arm-long-bar-row",
	...
	{
		_id: "shipped:exercise:one-arm-medicine-ball-slam",
	...
	{
		_id: "shipped:exercise:one-arm-open-palm-kettlebell-clean",
	...
	{
		_id: "shipped:exercise:one-arm-overhead-kettlebell-squats",
	...
	{
		_id: "shipped:exercise:one-arm-side-deadlift",
	...
	{
		_id: "shipped:exercise:one-arm-side-laterals",
	...
	{
		_id: "shipped:exercise:one-legged-cable-kickback",
	...
	{
		_id: "shipped:exercise:one-arm-chin-up",
	...
	{
		_id: "shipped:exercise:one-arm-dumbbell-bench-press",
	...
	{
		_id: "shipped:exercise:one-arm-dumbbell-preacher-curl",
	...
	{
		_id: "shipped:exercise:one-arm-floor-press",
	...
	{
		_id: "shipped:exercise:one-arm-lat-pulldown",
	...
	{
		_id: "shipped:exercise:one-arm-pronated-dumbbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:one-arm-supinated-dumbbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:one-leg-barbell-squat",
	...
	{
		_id: "shipped:exercise:open-palm-kettlebell-clean",
	...
	{
		_id: "shipped:exercise:otis-up",
		name: "Otis-Up",
		muscleGroups: ["core", "chest", "shoulders", "triceps"],
		category: "compound",
		equipment: "other",
		instructions: [
	...
	{
		_id: "shipped:exercise:overhead-cable-curl",
	...
	{
		_id: "shipped:exercise:overhead-squat",
		name: "Overhead Squat",
		muscleGroups: [
			"quadriceps",
			"core",
	...
	{
		_id: "shipped:exercise:pallof-press",
		name: "Pallof Press",
		muscleGroups: ["core", "chest", "shoulders", "triceps"],
		category: "isolation",
		equipment: "cable",
	...
	{
		_id: "shipped:exercise:pallof-press-with-rotation",
	...
	{
		_id: "shipped:exercise:palms-down-dumbbell-wrist-curl-over-a-bench",
	...
	{
		_id: "shipped:exercise:palms-down-wrist-curl-over-a-bench",
	...
	{
		_id: "shipped:exercise:palms-up-barbell-wrist-curl-over-a-bench",
	...
	{
		_id: "shipped:exercise:palms-up-dumbbell-wrist-curl-over-a-bench",
	...
	{
		_id: "shipped:exercise:physioball-hip-bridge",
	...
	{
		_id: "shipped:exercise:pin-presses",
		name: "Pin Presses",
		muscleGroups: ["triceps", "chest", "forearms", "back", "shoulders"],
		category: "compound",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:plate-pinch",
		name: "Plate Pinch",
		muscleGroups: ["forearms"],
		category: "isolation",
		equipment: "other",
	...
	{
		_id: "shipped:exercise:plate-twist",
		name: "Plate Twist",
		muscleGroups: ["core"],
		category: "compound",
		equipment: "other",
	...
	{
		_id: "shipped:exercise:platform-hamstring-slides",
	...
	{
		_id: "shipped:exercise:plie-dumbbell-squat",
	...
	{
		_id: "shipped:exercise:plyo-kettlebell-pushups",
	...
	{
		_id: "shipped:exercise:power-clean",
		name: "Power Clean",
		muscleGroups: [
			"hamstrings",
			"calves",
	...
	{
		_id: "shipped:exercise:power-clean-from-blocks",
	...
	{
		_id: "shipped:exercise:power-jerk",
		name: "Power Jerk",
		muscleGroups: [
			"quadriceps",
			"core",
	...
	{
		_id: "shipped:exercise:power-partials",
		name: "Power Partials",
		muscleGroups: ["shoulders"],
		category: "isolation",
		equipment: "dumbbell",
	...
	{
		_id: "shipped:exercise:power-snatch",
		name: "Power Snatch",
		muscleGroups: [
			"hamstrings",
			"calves",
	...
	{
		_id: "shipped:exercise:power-snatch-from-blocks",
	...
	{
		_id: "shipped:exercise:power-stairs",
		name: "Power Stairs",
		muscleGroups: [
			"hamstrings",
			"adductors",
	...
	{
		_id: "shipped:exercise:preacher-hammer-dumbbell-curl",
	...
	{
		_id: "shipped:exercise:press-sit-up",
		name: "Press Sit-Up",
		muscleGroups: ["core", "chest", "shoulders", "triceps"],
		category: "compound",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:prone-manual-hamstring",
	...
	{
		_id: "shipped:exercise:pull-through",
		name: "Pull Through",
	...
	{
		_id: "shipped:exercise:push-up-wide",
		name: "Push-Up Wide",
		muscleGroups: ["chest", "core", "shoulders", "triceps"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:push-ups-close-triceps-position",
	...
	{
		_id: "shipped:exercise:push-ups-with-feet-elevated",
	...
	{
		_id: "shipped:exercise:push-ups-with-feet-on-an-exercise-ball",
	...
	{
		_id: "shipped:exercise:push-press-behind-the-neck",
	...
	{
		_id: "shipped:exercise:push-up-to-side-plank",
	...
	{
		_id: "shipped:exercise:pushups-close-and-wide-hand-positions",
	...
	{
		_id: "shipped:exercise:rack-delivery",
		name: "Rack Delivery",
		muscleGroups: ["shoulders", "forearms", "traps"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:rack-pull-with-bands",
	...
	{
		_id: "shipped:exercise:rack-pulls",
		name: "Rack Pulls",
		muscleGroups: ["lower back", "forearms", "glutes", "hamstrings", "traps"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:reverse-band-bench-press",
	...
	{
		_id: "shipped:exercise:reverse-band-box-squat",
	...
	{
		_id: "shipped:exercise:reverse-band-deadlift",
	...
	{
		_id: "shipped:exercise:reverse-band-power-squat",
	...
	{
		_id: "shipped:exercise:reverse-band-sumo-deadlift",
	...
	{
		_id: "shipped:exercise:reverse-barbell-curl",
	...
	{
		_id: "shipped:exercise:reverse-barbell-preacher-curls",
	...
	{
		_id: "shipped:exercise:reverse-cable-curl",
	...
	{
		_id: "shipped:exercise:reverse-crunch",
		name: "Reverse Crunch",
		muscleGroups: ["core"],
		category: "isolation",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:reverse-flyes-with-external-rotation",
	...
	{
		_id: "shipped:exercise:reverse-grip-bent-over-rows",
	...
	{
		_id: "shipped:exercise:reverse-grip-triceps-pushdown",
	...
	{
		_id: "shipped:exercise:reverse-hyperextension",
	...
	{
		_id: "shipped:exercise:reverse-machine-flyes",
	...
	{
		_id: "shipped:exercise:reverse-plate-curls",
	...
	{
		_id: "shipped:exercise:reverse-triceps-bench-press",
	...
	{
		_id: "shipped:exercise:rickshaw-carry",
		name: "Rickshaw Carry",
		muscleGroups: [
			"forearms",
			"core",
	...
	{
		_id: "shipped:exercise:rickshaw-deadlift",
	...
	{
		_id: "shipped:exercise:ring-dips",
		name: "Ring Dips",
		muscleGroups: ["triceps", "chest", "shoulders"],
		category: "compound",
		equipment: "other",
	...
	{
		_id: "shipped:exercise:rocking-standing-calf-raise",
	...
	{
		_id: "shipped:exercise:rocky-pull-ups-pulldowns",
	...
	{
		_id: "shipped:exercise:romanian-deadlift-from-deficit",
		name: "Romanian Deadlift from Deficit",
		muscleGroups: ["hamstrings", "forearms", "glutes", "lower back", "traps"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:rope-climb",
		name: "Rope Climb",
		muscleGroups: ["back", "biceps", "forearms", "shoulders"],
		category: "compound",
		equipment: "other",
	...
	{
		_id: "shipped:exercise:rope-crunch",
		name: "Rope Crunch",
		muscleGroups: ["core"],
		category: "isolation",
		equipment: "cable",
	...
	{
		_id: "shipped:exercise:rope-straight-arm-pulldown",
	...
	{
		_id: "shipped:exercise:sandbag-load",
		name: "Sandbag Load",
		muscleGroups: [
			"quadriceps",
			"core",
	...
	{
		_id: "shipped:exercise:scapular-pull-up",
	...
	{
		_id: "shipped:exercise:seated-band-hamstring-curl",
	...
	{
		_id: "shipped:exercise:seated-barbell-military-press",
	...
	{
		_id: "shipped:exercise:seated-barbell-twist",
	...
	{
		_id: "shipped:exercise:seated-bent-over-one-arm-dumbbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:seated-bent-over-rear-delt-raise",
	...
	{
		_id: "shipped:exercise:seated-bent-over-two-arm-dumbbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:seated-cable-shoulder-press",
	...
	{
		_id: "shipped:exercise:seated-close-grip-concentration-barbell-curl",
	...
	{
		_id: "shipped:exercise:seated-dumbbell-curl",
	...
	{
		_id: "shipped:exercise:seated-dumbbell-inner-biceps-curl",
	...
	{
		_id: "shipped:exercise:seated-dumbbell-palms-down-wrist-curl",
	...
	{
		_id: "shipped:exercise:seated-dumbbell-palms-up-wrist-curl",
	...
	{
		_id: "shipped:exercise:seated-dumbbell-press",
	...
	{
		_id: "shipped:exercise:seated-flat-bench-leg-pull-in",
	...
	{
		_id: "shipped:exercise:seated-good-mornings",
	...
	{
		_id: "shipped:exercise:seated-head-harness-neck-resistance",
	...
	{
		_id: "shipped:exercise:seated-leg-curl",
	...
	{
		_id: "shipped:exercise:seated-leg-tucks",
	...
	{
		_id: "shipped:exercise:seated-one-arm-dumbbell-palms-down-wrist-curl",
	...
	{
		_id: "shipped:exercise:seated-one-arm-dumbbell-palms-up-wrist-curl",
	...
	{
		_id: "shipped:exercise:seated-one-arm-cable-pulley-rows",
	...
	{
		_id: "shipped:exercise:seated-palm-up-barbell-wrist-curl",
	...
	{
		_id: "shipped:exercise:seated-palms-down-barbell-wrist-curl",
	...
	{
		_id: "shipped:exercise:seated-side-lateral-raise",
	...
	{
		_id: "shipped:exercise:seated-triceps-press",
	...
	{
		_id: "shipped:exercise:seated-two-arm-palms-up-low-pulley-wrist-curl",
	...
	{
		_id: "shipped:exercise:see-saw-press-alternating-side-press",
	...
	{
		_id: "shipped:exercise:shotgun-row",
		name: "Shotgun Row",
		muscleGroups: ["back", "biceps"],
		category: "compound",
		equipment: "cable",
	...
	{
		_id: "shipped:exercise:shoulder-press-with-bands",
	...
	{
		_id: "shipped:exercise:side-laterals-to-front-raise",
	...
	{
		_id: "shipped:exercise:side-to-side-chins",
	...
	{
		_id: "shipped:exercise:single-arm-cable-crossover",
	...
	{
		_id: "shipped:exercise:single-arm-linear-jammer",
	...
	{
		_id: "shipped:exercise:single-arm-push-up",
	...
	{
		_id: "shipped:exercise:single-leg-high-box-squat",
	...
	{
		_id: "shipped:exercise:single-leg-leg-extension",
	...
	{
		_id: "shipped:exercise:single-dumbbell-raise",
	...
	{
		_id: "shipped:exercise:single-leg-glute-bridge",
	...
	{
		_id: "shipped:exercise:sled-drag-harness",
	...
	{
		_id: "shipped:exercise:sled-overhead-backward-walk",
		name: "Sled Overhead Backward Walk",
		muscleGroups: ["shoulders", "calves", "back", "quadriceps"],
		category: "compound",
		equipment: "other",
		instructions: [
	...
	{
		_id: "shipped:exercise:sled-overhead-triceps-extension",
	...
	{
		_id: "shipped:exercise:sled-push",
		name: "Sled Push",
		muscleGroups: [
			"quadriceps",
			"calves",
	...
	{
		_id: "shipped:exercise:sled-reverse-flye",
	...
	{
		_id: "shipped:exercise:smith-incline-shoulder-raise",
	...
	{
		_id: "shipped:exercise:smith-machine-behind-the-back-shrug",
	...
	{
		_id: "shipped:exercise:smith-machine-bench-press",
	...
	{
		_id: "shipped:exercise:smith-machine-bent-over-row",
	...
	{
		_id: "shipped:exercise:smith-machine-calf-raise",
	...
	{
		_id: "shipped:exercise:smith-machine-close-grip-bench-press",
	...
	{
		_id: "shipped:exercise:smith-machine-decline-press",
	...
	{
		_id: "shipped:exercise:smith-machine-hang-power-clean",
	...
	{
		_id: "shipped:exercise:smith-machine-hip-raise",
	...
	{
		_id: "shipped:exercise:smith-machine-incline-bench-press",
	...
	{
		_id: "shipped:exercise:smith-machine-leg-press",
	...
	{
		_id: "shipped:exercise:smith-machine-one-arm-upright-row",
	...
	{
		_id: "shipped:exercise:smith-machine-overhead-shoulder-press",
	...
	{
		_id: "shipped:exercise:smith-machine-pistol-squat",
	...
	{
		_id: "shipped:exercise:smith-machine-reverse-calf-raises",
	...
	{
		_id: "shipped:exercise:smith-machine-squat",
	...
	{
		_id: "shipped:exercise:smith-machine-stiff-legged-deadlift",
	...
	{
		_id: "shipped:exercise:smith-machine-upright-row",
		name: "Smith Machine Upright Row",
		muscleGroups: ["traps", "biceps", "back", "shoulders"],
		category: "compound",
		equipment: "machine",
		instructions: [
			"To begin, set the bar on the smith machine to a height that is around the middle of your thighs. Once the correct height is chosen and the bar is loaded, grasp the bar using a pronated (palms forward) grip that is shoulder width apart. You may need some wrist wraps if using a significant amount of weight.",
	...
	{
		_id: "shipped:exercise:smith-single-leg-split-squat",
	...
	{
		_id: "shipped:exercise:snatch-balance",
		name: "Snatch Balance",
		muscleGroups: [
			"quadriceps",
			"calves",
	...
	{
		_id: "shipped:exercise:snatch-deadlift",
	...
	{
		_id: "shipped:exercise:snatch-pull",
		name: "Snatch Pull",
		muscleGroups: [
			"hamstrings",
			"calves",
	...
	{
		_id: "shipped:exercise:snatch-shrug",
		name: "Snatch Shrug",
		muscleGroups: ["traps", "forearms", "shoulders"],
		category: "compound",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:snatch-from-blocks",
	...
	{
		_id: "shipped:exercise:speed-band-overhead-triceps",
	...
	{
		_id: "shipped:exercise:speed-box-squat",
	...
	{
		_id: "shipped:exercise:speed-squats",
		name: "Speed Squats",
		muscleGroups: [
			"quadriceps",
			"calves",
	...
	{
		_id: "shipped:exercise:spell-caster",
		name: "Spell Caster",
	...
	{
		_id: "shipped:exercise:spider-crawl",
		name: "Spider Crawl",
		muscleGroups: ["core", "chest", "shoulders", "triceps"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:spider-curl",
		name: "Spider Curl",
		muscleGroups: ["biceps"],
		category: "isolation",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:split-clean",
		name: "Split Clean",
		muscleGroups: [
			"quadriceps",
			"calves",
	...
	{
		_id: "shipped:exercise:split-jerk",
		name: "Split Jerk",
		muscleGroups: [
			"quadriceps",
			"glutes",
	...
	{
		_id: "shipped:exercise:split-snatch",
		name: "Split Snatch",
		muscleGroups: [
			"hamstrings",
			"calves",
	...
	{
		_id: "shipped:exercise:split-squat-with-dumbbells",
	...
	{
		_id: "shipped:exercise:squat-jerk",
		name: "Squat Jerk",
		muscleGroups: [
			"quadriceps",
			"calves",
	...
	{
		_id: "shipped:exercise:squat-with-bands",
	...
	{
		_id: "shipped:exercise:squat-with-chains",
	...
	{
		_id: "shipped:exercise:squat-with-plate-movers",
	...
	{
		_id: "shipped:exercise:squats-with-bands",
	...
	{
		_id: "shipped:exercise:standing-alternating-dumbbell-press",
	...
	{
		_id: "shipped:exercise:standing-barbell-calf-raise",
	...
	{
		_id: "shipped:exercise:standing-barbell-press-behind-neck",
	...
	{
		_id: "shipped:exercise:standing-bent-over-one-arm-dumbbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:standing-bent-over-two-arm-dumbbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:standing-biceps-cable-curl",
	...
	{
		_id: "shipped:exercise:standing-bradford-press",
	...
	{
		_id: "shipped:exercise:standing-cable-chest-press",
	...
	{
		_id: "shipped:exercise:standing-cable-lift",
	...
	{
		_id: "shipped:exercise:standing-cable-wood-chop",
	...
	{
		_id: "shipped:exercise:standing-concentration-curl",
	...
	{
		_id: "shipped:exercise:standing-dumbbell-calf-raise",
	...
	{
		_id: "shipped:exercise:standing-dumbbell-press",
	...
	{
		_id: "shipped:exercise:standing-dumbbell-reverse-curl",
	...
	{
		_id: "shipped:exercise:standing-dumbbell-straight-arm-front-delt-raise-above-head",
	...
	{
		_id: "shipped:exercise:standing-dumbbell-upright-row",
		name: "Standing Dumbbell Upright Row",
		muscleGroups: ["traps", "biceps", "shoulders"],
		category: "compound",
		equipment: "dumbbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:standing-front-barbell-raise-over-head",
	...
	{
		_id: "shipped:exercise:standing-inner-biceps-curl",
	...
	{
		_id: "shipped:exercise:standing-leg-curl",
	...
	{
		_id: "shipped:exercise:standing-low-pulley-one-arm-triceps-extension",
	...
	{
		_id: "shipped:exercise:standing-olympic-plate-hand-squeeze",
	...
	{
		_id: "shipped:exercise:standing-one-arm-cable-curl",
	...
	{
		_id: "shipped:exercise:standing-one-arm-dumbbell-curl-over-incline-bench",
	...
	{
		_id: "shipped:exercise:standing-one-arm-dumbbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:standing-overhead-barbell-triceps-extension",
	...
	{
		_id: "shipped:exercise:standing-palm-in-one-arm-dumbbell-press",
	...
	{
		_id: "shipped:exercise:standing-palms-in-dumbbell-press",
	...
	{
		_id: "shipped:exercise:standing-palms-up-barbell-behind-the-back-wrist-curl",
	...
	{
		_id: "shipped:exercise:standing-rope-crunch",
	...
	{
		_id: "shipped:exercise:standing-towel-triceps-extension",
	...
	{
		_id: "shipped:exercise:step-up-with-knee-raise",
	...
	{
		_id: "shipped:exercise:stiff-legged-barbell-deadlift",
	...
	{
		_id: "shipped:exercise:stiff-legged-dumbbell-deadlift",
	...
	{
		_id: "shipped:exercise:stiff-leg-barbell-good-morning",
	...
	{
		_id: "shipped:exercise:straight-arm-dumbbell-pullover",
	...
	{
		_id: "shipped:exercise:straight-arm-pulldown",
	...
	{
		_id: "shipped:exercise:straight-bar-bench-mid-rows",
	...
	{
		_id: "shipped:exercise:straight-raises-on-incline-bench",
	...
	{
		_id: "shipped:exercise:sumo-deadlift-with-bands",
	...
	{
		_id: "shipped:exercise:sumo-deadlift-with-chains",
	...
	{
		_id: "shipped:exercise:suspended-fallout",
		name: "Suspended Fallout",
		muscleGroups: ["core", "chest", "lower back", "shoulders"],
		category: "isolation",
		equipment: "other",
		instructions: [
	...
	{
		_id: "shipped:exercise:suspended-push-up",
	...
	{
		_id: "shipped:exercise:suspended-reverse-crunch",
	...
	{
		_id: "shipped:exercise:suspended-row",
		name: "Suspended Row",
		muscleGroups: ["back", "biceps"],
		category: "compound",
		equipment: "other",
	...
	{
		_id: "shipped:exercise:suspended-split-squat",
	...
	{
		_id: "shipped:exercise:svend-press",
		name: "Svend Press",
	...
	{
		_id: "shipped:exercise:tate-press",
		name: "Tate Press",
		muscleGroups: ["triceps", "chest", "shoulders"],
		category: "isolation",
		equipment: "dumbbell",
	...
	{
		_id: "shipped:exercise:thigh-abductor",
		name: "Thigh Abductor",
	...
	{
		_id: "shipped:exercise:thigh-adductor",
		name: "Thigh Adductor",
	...
	{
		_id: "shipped:exercise:tire-flip",
		name: "Tire Flip",
		muscleGroups: [
			"quadriceps",
			"calves",
	...
	{
		_id: "shipped:exercise:trap-bar-deadlift",
	...
	{
		_id: "shipped:exercise:tricep-dumbbell-kickback",
	...
	{
		_id: "shipped:exercise:triceps-overhead-extension-with-rope",
	...
	{
		_id: "shipped:exercise:triceps-pushdown-rope-attachment",
	...
	{
		_id: "shipped:exercise:triceps-pushdown-v-bar-attachment",
	...
	{
		_id: "shipped:exercise:tuck-crunch",
		name: "Tuck Crunch",
		muscleGroups: ["core"],
		category: "isolation",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:two-arm-dumbbell-preacher-curl",
	...
	{
		_id: "shipped:exercise:two-arm-kettlebell-clean",
	...
	{
		_id: "shipped:exercise:two-arm-kettlebell-jerk",
	...
	{
		_id: "shipped:exercise:two-arm-kettlebell-military-press",
	...
	{
		_id: "shipped:exercise:two-arm-kettlebell-row",
	...
	{
		_id: "shipped:exercise:underhand-cable-pulldowns",
	...
	{
		_id: "shipped:exercise:upright-barbell-row",
	...
	{
		_id: "shipped:exercise:upright-cable-row",
	...
	{
		_id: "shipped:exercise:upright-row-with-bands",
	...
	{
		_id: "shipped:exercise:v-bar-pulldown",
		name: "V-Bar Pulldown",
		muscleGroups: ["back", "biceps", "shoulders"],
		category: "compound",
		equipment: "cable",
	...
	{
		_id: "shipped:exercise:v-bar-pullup",
		name: "V-Bar Pullup",
		muscleGroups: ["back", "biceps", "shoulders"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:weighted-ball-hyperextension",
		name: "Weighted Ball Hyperextension",
		muscleGroups: ["lower back", "glutes", "hamstrings", "back"],
		category: "compound",
		equipment: "other",
		instructions: [
	...
	{
		_id: "shipped:exercise:weighted-ball-side-bend",
	...
	{
		_id: "shipped:exercise:weighted-bench-dip",
	...
	{
		_id: "shipped:exercise:weighted-crunches",
	...
	{
		_id: "shipped:exercise:weighted-jump-squat",
	...
	{
		_id: "shipped:exercise:weighted-pull-ups",
	...
	{
		_id: "shipped:exercise:weighted-sissy-squat",
	...
	{
		_id: "shipped:exercise:weighted-sit-ups-with-bands",
	...
	{
		_id: "shipped:exercise:weighted-squat",
		name: "Weighted Squat",
		muscleGroups: ["quadriceps", "calves", "glutes", "hamstrings"],
		category: "compound",
		equipment: "other",
	...
	{
		_id: "shipped:exercise:wide-grip-barbell-bench-press",
	...
	{
		_id: "shipped:exercise:wide-grip-decline-barbell-bench-press",
	...
	{
		_id: "shipped:exercise:wide-grip-decline-barbell-pullover",
	...
	{
		_id: "shipped:exercise:wide-grip-pulldown-behind-the-neck",
	...
	{
		_id: "shipped:exercise:wide-grip-rear-pull-up",
	...
	{
		_id: "shipped:exercise:wide-grip-standing-barbell-curl",
	...
	{
		_id: "shipped:exercise:wide-stance-barbell-squat",
	...
	{
		_id: "shipped:exercise:wide-stance-stiff-legs",
		name: "Wide Stance Stiff Legs",
		muscleGroups: ["hamstrings", "adductors", "glutes", "lower back"],
		category: "compound",
		equipment: "barbell",
		instructions: [
	...
	{
		_id: "shipped:exercise:wind-sprints",
		name: "Wind Sprints",
		muscleGroups: ["core"],
		category: "compound",
		equipment: "bodyweight",
	...
	{
		_id: "shipped:exercise:wrist-roller",
		name: "Wrist Roller",
	...
	{
		_id: "shipped:exercise:wrist-rotations-with-straight-bar",
	...
	{
		_id: "shipped:exercise:yoke-walk",
		name: "Yoke Walk",
		muscleGroups: [
			"quadriceps",
			"core",
	...
	{
		_id: "shipped:exercise:zercher-squats",
		name: "Zercher Squats",
		muscleGroups: ["quadriceps", "calves", "glutes", "hamstrings"],
		category: "compound",
		equipment: "barbell",
	...
	{
		_id: "shipped:exercise:zottman-curl",
		name: "Zottman Curl",
		muscleGroups: ["biceps", "forearms"],
		category: "isolation",
		equipment: "dumbbell",
	...
	{
		_id: "shipped:exercise:zottman-preacher-curl",
