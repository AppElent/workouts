import { WRKOUT_EXERCISES } from "./wrkoutExercises";

// Curated exercise library shipped with the app.
...
export const CURATED_EXERCISES: DefaultExercise[] = [
	// ─── Existing 15 (instructions backfilled) ─────────────────────────────────
	{
		name: "Barbell Back Squat",
		_id: "shipped:exercise:barbell-back-squat",
	...
	},
	{
		...
		_id: "shipped:exercise:barbell-bench-press",
	...
	},
	{
		...
		_id: "shipped:exercise:barbell-deadlift",
	...
	},
	{
		...
		_id: "shipped:exercise:barbell-overhead-press",
	...
	{
		name: "Barbell Row",
		_id: "shipped:exercise:barbell-row",
	...
	{
		name: "Dumbbell Curl",
		_id: "shipped:exercise:dumbbell-curl",
		muscleGroups: ["biceps"],
		category: "isolation",
		equipment: "dumbbell",
		weightIncrement: 2,
	...
	},
	{
		...
		_id: "shipped:exercise:tricep-pushdown",
	...
	{
		name: "Leg Press",
		_id: "shipped:exercise:leg-press",
	...
	},
	{
		...
		_id: "shipped:exercise:romanian-deadlift",
	...
	},
	{
		...
		_id: "shipped:exercise:dumbbell-lateral-raise",
	...
	{
		name: "Cable Row",
		_id: "shipped:exercise:cable-row",
		muscleGroups: ["back", "biceps"],
		category: "compound",
		equipment: "cable",
		weightIncrement: 2.5,
	...
	},
	{
		...
		_id: "shipped:exercise:dumbbell-bench-press",
		muscleGroups: ["chest", "triceps", "shoulders"],
		category: "compound",
		equipment: "dumbbell",
		weightIncrement: 2,
	...
	},
	{
		...
		_id: "shipped:exercise:incline-barbell-press",
	...
	},
	{
		...
		_id: "shipped:exercise:kettlebell-swing",
	...
	{
		name: "Dumbbell Fly",
		_id: "shipped:exercise:dumbbell-fly",
		muscleGroups: ["chest"],
		category: "isolation",
		equipment: "dumbbell",
		weightIncrement: 2,
	...
	{
		name: "Cable Fly",
		_id: "shipped:exercise:cable-fly",
		muscleGroups: ["chest"],
		category: "isolation",
		equipment: "cable",
		weightIncrement: 2.5,
	...
	},
	{
		...
		_id: "shipped:exercise:decline-barbell-press",
	...
	},
	{
		...
		_id: "shipped:exercise:close-grip-bench-press",
	...
	{
		name: "Lat Pulldown",
		_id: "shipped:exercise:lat-pulldown",
	...
	{
		name: "T-Bar Row",
		_id: "shipped:exercise:t-bar-row",
	...
	},
	{
		...
		_id: "shipped:exercise:single-arm-dumbbell-row",
		muscleGroups: ["back", "lats", "biceps"],
		category: "compound",
		equipment: "dumbbell",
		weightIncrement: 2,
	...
	{
		name: "Pendlay Row",
		_id: "shipped:exercise:pendlay-row",
	...
	{
		name: "Face Pull",
		_id: "shipped:exercise:face-pull",
	...
	{
		name: "Hyperextension",
		_id: "shipped:exercise:hyperextension",
	...
	{
		name: "Barbell Shrug",
		_id: "shipped:exercise:barbell-shrug",
		muscleGroups: ["traps"],
		category: "isolation",
		equipment: "barbell",
		weightIncrement: 2.5,
	...
	{
		name: "Front Squat",
		_id: "shipped:exercise:front-squat",
	...
	},
	{
		...
		_id: "shipped:exercise:bulgarian-split-squat",
		muscleGroups: ["quadriceps", "glutes", "hamstrings"],
		category: "compound",
		equipment: "dumbbell",
		weightIncrement: 2,
	...
	{
		name: "Walking Lunge",
		_id: "shipped:exercise:walking-lunge",
		muscleGroups: ["quadriceps", "glutes", "hamstrings"],
		category: "compound",
		equipment: "dumbbell",
		weightIncrement: 2,
	...
	{
		name: "Hip Thrust",
		_id: "shipped:exercise:hip-thrust",
	...
	{
		name: "Goblet Squat",
		_id: "shipped:exercise:goblet-squat",
		muscleGroups: ["quadriceps", "glutes", "core"],
		category: "compound",
		equipment: "kettlebell",
		weightIncrement: 4,
	...
	{
		name: "Lying Leg Curl",
		_id: "shipped:exercise:lying-leg-curl",
	...
	{
		name: "Leg Extension",
		_id: "shipped:exercise:leg-extension",
	...
	},
	{
		...
		_id: "shipped:exercise:standing-calf-raise",
		muscleGroups: ["calves"],
		category: "isolation",
		equipment: "machine",
		weightIncrement: 2.5,
	...
	},
	{
		...
		_id: "shipped:exercise:seated-calf-raise",
		muscleGroups: ["calves"],
		category: "isolation",
		equipment: "machine",
		weightIncrement: 2.5,
	...
	{
		name: "Sumo Deadlift",
		_id: "shipped:exercise:sumo-deadlift",
	...
	{
		name: "Good Morning",
		_id: "shipped:exercise:good-morning",
	...
	{
		name: "Arnold Press",
		_id: "shipped:exercise:arnold-press",
		muscleGroups: ["shoulders", "triceps"],
		category: "compound",
		equipment: "dumbbell",
		weightIncrement: 2,
	...
	},
	{
		...
		_id: "shipped:exercise:cable-lateral-raise",
		muscleGroups: ["shoulders"],
		category: "isolation",
		equipment: "cable",
		weightIncrement: 2.5,
	...
	},
	{
		...
		_id: "shipped:exercise:dumbbell-reverse-fly",
	...
	{
		name: "Hammer Curl",
		_id: "shipped:exercise:hammer-curl",
	...
	{
		name: "EZ-Bar Curl",
		_id: "shipped:exercise:ez-bar-curl",
		muscleGroups: ["biceps"],
		category: "isolation",
		equipment: "barbell",
		weightIncrement: 1.25,
	...
	{
		name: "Preacher Curl",
		_id: "shipped:exercise:preacher-curl",
		muscleGroups: ["biceps"],
		category: "isolation",
		equipment: "barbell",
		weightIncrement: 1.25,
	...
	{
		name: "Skull Crusher",
		_id: "shipped:exercise:skull-crusher",
		muscleGroups: ["triceps"],
		category: "isolation",
		equipment: "barbell",
		weightIncrement: 1.25,
	...
	},
	{
		...
		_id: "shipped:exercise:overhead-tricep-extension",
		muscleGroups: ["triceps"],
		category: "isolation",
		equipment: "dumbbell",
		weightIncrement: 2,
	...
	},
	{
		...
		_id: "shipped:exercise:hanging-leg-raise",
		muscleGroups: ["core"],
		category: "isolation",
		equipment: "bodyweight",
		instructions: [
	...
	{
		name: "Cable Crunch",
		_id: "shipped:exercise:cable-crunch",
		muscleGroups: ["core"],
		category: "isolation",
		equipment: "cable",
		weightIncrement: 2.5,
	...
	},
	{
		...
		_id: "shipped:exercise:ab-wheel-rollout",
		muscleGroups: ["core"],
		category: "compound",
		equipment: "other",
		instructions: [
	...
	{
		name: "Russian Twist",
		_id: "shipped:exercise:russian-twist",
		muscleGroups: ["core"],
		category: "isolation",
		equipment: "bodyweight",
		instructions: [
...
// Keep the original entries first and unchanged for existing workout history.
