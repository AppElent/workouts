...
import {
	...
	loadOrderDraft,
	saveOrderDraft,
} from "#/hooks/useWorkoutFormDraft";
...
function ActiveSessionPage() {
	...
	const [exerciseOrder, setExerciseOrder] = useState<Id<"exercises">[]>(
		() => loadOrderDraft(sessionId as Id<"workoutSessions">) ?? [],
	);

	useEffect(() => {
		saveOrderDraft(sessionId as Id<"workoutSessions">, exerciseOrder);
	}, [exerciseOrder, sessionId]);
	...
	async function handleFinish() {
		clearSessionDrafts(sessionId as Id<"workoutSessions">);
